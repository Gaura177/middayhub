      ...
      <div className={styles.container}>
        ...
        <div className={styles.countdown}>
          <div className={styles["countdown-item"]}>
            <div className={styles["countdown-number"]} id="days">
              30
            </div>
            <div className={styles["countdown-label"]}>Days</div>
          </div>
          <div className={styles["countdown-item"]}>
            <div className={styles["countdown-number"]} id="hours">
              24
            </div>
            <div className={styles["countdown-label"]}>Hours</div>
          </div>
          <div className={styles["countdown-item"]}>
            <div className={styles["countdown-number"]} id="minutes">
              60
            </div>
            <div className={styles["countdown-label"]}>Minutes</div>
          </div>
          <div className={styles["countdown-item"]}>
            <div className={styles["countdown-number"]} id="seconds">
              60
            </div>
